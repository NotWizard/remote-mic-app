...
| 2026-08-21 | [界面违反本仓库自己写下的字号与本地化规则](./2026-08-21-interface-breaks-the-projects-own-font-and-locale-rules.md) | 字号、弹窗本地化与映射页布局已修复，自动化通过；**未做任何真实窗口渲染验收**；`minSize` 与 `800 × 650` 门禁矛盾的门禁措辞已由 `a7b5c4d` 改为跟随生产 `minSize`（`minSize` 未改） |
